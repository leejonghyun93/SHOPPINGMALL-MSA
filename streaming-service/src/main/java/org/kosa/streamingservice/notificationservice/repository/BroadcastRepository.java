package org.kosa.streamingservice.notificationservice.repository;
...
public interface BroadcastRepository extends JpaRepository<BroadcastEntity, Long> {
    ...
    // ========== 🔥 실제 운영용: broadcaster_id만 사용하는 메서드들 (String으로 변경) ==========

    /**
     * 🔥 broadcaster_id만 조회 (String 타입으로 변경)
     */
    ...
    /**
     * 🔥 broadcaster_id별 방송 개수 조회 (String 타입으로 변경)
     */
    long countByBroadcasterId(String broadcasterId);

    /**
     * 🔥 현재 시작하는 방송들의 broadcaster_id 목록 조회 (String 타입으로 변경)
     */
